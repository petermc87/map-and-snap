...
export default function Faqs () {
  const faqs = [
    ...
    'Photogrammetry extracts measurements, creates 3D models from photos, benefiting your business with accurate representations for architecture, engineering, VR, and gaming.',
